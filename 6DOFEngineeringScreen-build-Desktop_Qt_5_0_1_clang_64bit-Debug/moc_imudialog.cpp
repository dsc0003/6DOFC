...
struct qt_meta_stringdata_IMUDialog_t {
    QByteArrayData data[9];
    char stringdata[79];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_IMUDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_IMUDialog_t qt_meta_stringdata_IMUDialog = {
    {
...
QT_MOC_LITERAL(8, 71, 6)
    ...
    "IMUDialog\0connectit\0\0discon\0stopStream\0"
    "stream\0onReadyRead\0onDsrChanged\0status\0"
};
...
const QMetaObject IMUDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_IMUDialog.data,
      qt_meta_data_IMUDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IMUDialog.stringdata))
