...
public:
    ...
    QLineEdit *le_errorR0;
    QLabel *label_21;
    QLineEdit *le_errorR1;
    ...
    QLabel *R0Label;
    QLineEdit *le_countR0;
    QLabel *label_20;
    QLineEdit *le_countR1;
    QLineEdit *le_errorR2;
    QLineEdit *le_countR2;
    QLineEdit *le_countR3;
    QLineEdit *le_errorR3;
    QLabel *label_18;
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        gridLayout_3->addWidget(YawLabel, 1, 0, 1, 1);

        PitchLabel = new QLabel(tab);
        PitchLabel->setObjectName(QStringLiteral("PitchLabel"));

        gridLayout_3->addWidget(PitchLabel, 2, 0, 1, 1);
        ...
        gridLayout_5->addWidget(pauseButton, 1, 3, 1, 1);

        gridLayout = new QGridLayout();
        gridLayout->setSpacing(6);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        le_errorR0 = new QLineEdit(tab);
        le_errorR0->setObjectName(QStringLiteral("le_errorR0"));
        le_errorR0->setReadOnly(true);

        gridLayout->addWidget(le_errorR0, 1, 4, 1, 1);
        ...
        le_countR1 = new QLineEdit(tab);
        le_countR1->setObjectName(QStringLiteral("le_countR1"));
        le_countR1->setReadOnly(true);

        gridLayout->addWidget(le_countR1, 2, 3, 1, 1);

        le_errorR2 = new QLineEdit(tab);
        le_errorR2->setObjectName(QStringLiteral("le_errorR2"));
        le_errorR2->setReadOnly(true);

        gridLayout->addWidget(le_errorR2, 3, 4, 1, 1);

        le_countR2 = new QLineEdit(tab);
        le_countR2->setObjectName(QStringLiteral("le_countR2"));
        le_countR2->setReadOnly(true);

        gridLayout->addWidget(le_countR2, 3, 3, 1, 1);

        le_countR3 = new QLineEdit(tab);
        le_countR3->setObjectName(QStringLiteral("le_countR3"));
        le_countR3->setReadOnly(true);

        gridLayout->addWidget(le_countR3, 4, 3, 1, 1);

        le_errorR3 = new QLineEdit(tab);
        le_errorR3->setObjectName(QStringLiteral("le_errorR3"));
        le_errorR3->setReadOnly(true);

        gridLayout->addWidget(le_errorR3, 4, 4, 1, 1);
        ...
        gridLayout_5->addLayout(gridLayout, 0, 3, 1, 1);
        ...
        gridLayout_5->addWidget(line, 0, 2, 1, 1);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label_19->setText(QApplication::translate("Dialog", "Position", 0));
        ...
        label_22->setText(QApplication::translate("Dialog", "Rotation", 0));
        pauseButton->setText(QApplication::translate("Dialog", "Start", 0));
        label_21->setText(QApplication::translate("Dialog", "Error Threshold Count", 0));
        ...
        label_20->setText(QApplication::translate("Dialog", "Timeout Count", 0));
        label_18->setText(QApplication::translate("Dialog", "Ranges", 0));
