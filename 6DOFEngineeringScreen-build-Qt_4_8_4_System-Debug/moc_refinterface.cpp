...
**
** Created: Tue Apr 16 19:22:13 2013
...
static const char qt_meta_stringdata_RefInterface[] = {
    "RefInterface\0\0getIMUData()\0"
};
...
const QMetaObjectExtraData RefInterface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RefInterface::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_RefInterface,
      qt_meta_data_RefInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RefInterface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RefInterface))
