...
**
** Created: Tue Apr 16 19:22:09 2013
...
static const char qt_meta_stringdata_Dialog[] = {
    "Dialog\0\0pause()\0x,y,z,R0,R1,R2,R3,roll,pitch,yaw\0"
    "updateDisplay(float,float,float,float,float,float,float,float,float,fl"
    "oat)\0"
    "x,y,z,R0,R1,R2,R3,roll,pitch,yaw,reqNode\0"
    "log(float,float,float,float,float,float,float,float,float,float,QStrin"
    "g)\0"
